# start-project-angular-webpack

>Inspired by [angularjs-webpack](https://github.com/preboot/angularjs-webpack.git)
...
```bash
# clone our repo
$ git clone https://github.com/ozotto/start-project-angular-webpack.git my-app
